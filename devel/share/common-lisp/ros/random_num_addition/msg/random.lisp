...
(cl:defmethod cl:initialize-instance :after ((m <random>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'random)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name random_num_addition-msg:<random> is deprecated: use random_num_addition-msg:random instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <random>))
...
(cl:defmethod y-val ((m <random>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader random_num_addition-msg:y-val is deprecated.  Use random_num_addition-msg:y instead.")
  (y m))
